...
-(void)prepareAlertToDisplay:(XYAlertView*)entity
{
    ...
    _titleLabel.textColor = entity.titleFontColor;
    _titleLabel.font = [UIFont boldSystemFontOfSize:20];
    _titleLabel.text = entity.title;
    [_alertView addSubview:_titleLabel];
    
    UILabel *_messageLabel = [[UILabel alloc] initWithFrame:CGRectMake(25, 40, 240, 60)];
    _messageLabel.textAlignment = NSTextAlignmentLeft;
    _messageLabel.backgroundColor = [UIColor clearColor];
    _messageLabel.textColor = entity.messageFontColor;
...
-(void)showAlertViewWithAnimation:(id)entity
{
    if([entity isKindOfClass:[XYAlertView class]])
    {
        ...
        UIView *containerView = [keyWindow.subviews lastObject];
        ...
        [containerView bringSubviewToFront:_alertView];
